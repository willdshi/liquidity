function testspec = crsp_testcache_lqmeas()
    ...
    testspec.EXIST{4} = 'CACHE.data.SAM_BID';
    testspec.EXIST{5} = 'CACHE.data.SAM_ASK';
    testspec.EXIST{6} = 'CACHE.data.SAM_SHR';
    testspec.EXIST{7} = 'CACHE.data.SAM_PRC';
%     testspec.EXIST{8} = 'CACHE.liqmeas.AMIH';
%     testspec.EXIST{9} = 'CACHE.liqmeas.MINVx';
%     testspec.EXIST{10} = 'CACHE.liqmeas.MINV1';
    testspec.EXIST{8} = 'CACHE.liqmeas.MINV2';
%     testspec.EXIST{12} = 'CACHE.liqmeas.MART';
%     testspec.EXIST{13} = 'CACHE.liqmeas.TURN';
